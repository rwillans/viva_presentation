...
nocite: |
  @asmildScaleHospitalProduction2013
---
...
This chapter uses more recent and comprehensive data, including input prices, to model a multiproduct cost function and consequent scale economies, computed using the method originally defined by Baumol (Panzar and Willig, The main result is the finding of small but positive economies of scale up to the level of approximately 1,100 beds.
